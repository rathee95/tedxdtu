        ...
        <div class="columns small-12 medium-12 large-12">
            <div class="mb">
                ...
                <ul id="menu-main-menu-homepage" class="menu">
                    ...
                    <li id="menu-item-72" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-72"><a href="/#speakers">Speakers</a></li>
                    ...
                    <li id="menu-item-77" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-77"><a href="#">Custom Pages</a>
                        <ul class="sub-menu">
                            <li id="menu-item-78" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78"><a href="speakers.php">Speakers</a></li>
    ...
    <div class="mini_header">
        ...
        <div class="row">
            <div class="columns small-12 medium-12 large-12">
                ...
                <div class="sub-logo">
                    <h2 id="site-description">April 11 , 2016</h2>
                </div>
            </div>
        </div>
    </div>
